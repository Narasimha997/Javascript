...
arr1[0]="hi"; 
console.log(arr1);
arr1=["hi there,you"]   // It will uodate and overwrites the old one 
console.log(arr1);
// Using const and trying to update value in an array
const arr2=["hi,hello"];
arr2[0]="hi";
console.log(arr2);   // Here it didnt effect the const why because we used the index number to update the inside of an array so won't show any errror
